...
inline
typename std::array< std::reference_wrapper< INode< Ts... > >, N>::iterator
...
template< typename... Ts, typename Derived, size_t N >
inline
typename std::array< std::reference_wrapper< INode< Ts... > >, N>::const_iterator
...
inline
typename std::vector< std::reference_wrapper< INode< Ts... > > >::iterator
...
template< typename... Ts, typename Derived >
inline
typename std::vector< std::reference_wrapper< INode< Ts... > > >::const_iterator
