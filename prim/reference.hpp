...
protected:
    // prim::Value can be implicitly cast to reference& and we can't allow meddling with its insides
...
public:
  ...
  friend unwrap_<                base&& > operator*(                reference&& ref ){ return {static_cast<               base&&>(ref)}; }
  friend unwrap_< const          base&& > operator*( const          reference&& ref ){ return {static_cast<const          base&&>(ref)}; }
  friend unwrap_<       volatile base&  > operator*(       volatile reference&  ref ){ return {static_cast<      volatile base& >(ref)}; }
  friend unwrap_< const volatile base&  > operator*( const volatile reference&  ref ){ return {static_cast<const volatile base& >(ref)}; }
  friend unwrap_<       volatile base&& > operator*(       volatile reference&& ref ){ return {static_cast<      volatile base&&>(ref)}; }
  friend unwrap_< const volatile base&& > operator*( const volatile reference&& ref ){ return {static_cast<const volatile base&&>(ref)}; }
